...
<body>
  ...
  <div class="main">
    ...
    <div class="mb-3">
      <button class="btn btn-add" onclick="window.location.href='product-add'">Add Product</button>
    </div>
        ...
        <tbody>
          <c:forEach var="products" items="${products}">
            <tr>
              <td>${products.name}</td>
              <td>
                <img src="resources/AdminModel/img/Products/${products.imageUrl}" alt="Product Image" width="80"
                  height="80" />
              </td>
              ...
              <td>
                <a href="listSearchCategory?id=${category.id}" class="text-primary me-3">
