...
<body>
    ...
    <div class="card text-center">
        ...
        <img src="resources/AdminModel/img/Products/${product.imageUrl}" class="img-fluid product-img mb-3"
             alt="${product.name}" />
    ...
    <script>
        const options = {
            "key": "rzp_test_2OjlUnmJ9MerLw", // ✅ Your Razorpay Test Key
            ...
            "handler": function (response) {
                fetch("razorpaySuccess", {
                    ...
                    alert("Payment succeeded but couldn't reach the server.");
                });
            },
            "prefill": {
                "name": "${sessionScope.user.firstName} ${sessionScope.user.lastName}",
                "email": "${sessionScope.user.email}",
                "contact": "${sessionScope.user.mobileNo}"
            },
            "theme": {
                "color": "#198754"
            }
